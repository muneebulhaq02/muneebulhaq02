# 👋 Hi, I'm Muneeb Ul Haq

🎓 BS Computer Science Student at FAST NUCES
🏅 Dean's List Recipient (Spring 2024, Fall 2024, Fall 2025, Spring 2026)
...
Developed a real-time multi-user chat system with socket programming, multithreading, direct messaging, and encrypted communication.

🩺 **Cancer Risk Prediction using KNN**
Performed data analysis, feature selection, and machine learning model evaluation using K-Nearest Neighbors.
